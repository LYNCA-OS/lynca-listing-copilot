...
function compactV4L2RecognitionPrompt(payload, maxTitleLength) {
  ...
  return [
    ...
    "Numerical Rarity evidence: 2/3, 14/99, 31/50, #/50, and 1/1 are limited-numbering evidence for the CSM field Numerical Rarity. Store the evidence in print_run_number / print_run_denominator fields for compatibility. Preserve visible full numerator/denominator from the current image. If only denominator is supported, use #/D. Do not treat limited numbering as collector_number/checklist_code/card_number/tcg_card_number.",
