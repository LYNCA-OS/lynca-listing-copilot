...
This is a secret-free, read-only audit of project `irpgnhkslrsiucybkufc`. Remote SQL was fetched into an isolated temporary directory and discarded after hashing; no SQL body, connection string, token, or password is persisted here.
...
| `20260801115421` | exact | `20260801115421_csm_thin_provider_pacer_v1.sql` | `20260801115421_csm_thin_provider_pacer_v1.sql` | byte_identical |
