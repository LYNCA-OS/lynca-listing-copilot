...
| --- | ---: | ---: | ---: | --- |
| First-time image, full Provider | 1 | 11.407 s | 20.046 s | Provider component observed; complete stage budget not yet proven end to end |
...
- The 60 familiar observations in
  [`docs/target-architecture.md`](../target-architecture.md) recorded Provider
...
## Path 1: first-time image, full Provider observation

This route is mandatory after replay misses and current-image evidence cannot
prove one unique, conflict-free Official or independently Reviewed identity.
