...
function normalizeBoolean(value) {
  ...
  return /^(true|yes|y|1|rc|rookie|auto|autograph|ssp|case hit|patch|relic|sketch|redemption|1\/1)$/i.test(normalizeText(value));
}
...
export function canonicalValueKey(field, value) {
  ...
  return normalizeText(normalized).toLowerCase().replace(/[^a-z0-9/]+/g, " ").replace(/\s+/g, " ").trim();
}
