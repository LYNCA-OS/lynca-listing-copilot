...
import { normalizeGradeCompanyValue } from "../listing/grade/grade-company.mjs";
...
const fieldAliases = Object.freeze({
  ...
  serialLimit: "numerical_rarity",
  serial_limit: "numerical_rarity",
  grade: "card_grade",
...
const sourceAliases = Object.freeze({
  ...
  MULTI_CARD_DETECTOR: "MULTI_CARD_DETECTOR",
...
export function normalizeFieldValue(field, value) {
  ...
  if (field === "serial_number" || field === "numerical_rarity") return normalizeSerial(value);
...
export function sourceIsGroundTruthEligible(source) {
  ...
  return !["MARKETPLACE", "VISUAL_GUESS", "MODEL_INFERENCE", "MODEL_WORLD_KNOWLEDGE", "PRIMARY_FAST_VISION"].includes(normalized);
}
