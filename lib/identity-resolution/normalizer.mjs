...
const sourceAliases = Object.freeze({
  ...
  GEMINI: "PRIMARY_FAST_VISION",
  GEMINI_PRIMARY_FAST_VISION: "PRIMARY_FAST_VISION",
...
export function sourceIsGroundTruthEligible(source) {
  ...
  return !["MARKETPLACE", "VISUAL_GUESS", "AGNES_INFERENCE", "PRIMARY_FAST_VISION"].includes(normalized);
}
