...
function buildFieldLevelPublication({
  ...
  Object.entries(activeIdentity || {}).forEach(([field, value]) => {
    ...
    publishableFields[field] = {
      ...
      source: autoPublishAllowed ? "auto_publish_identity" : "partial_writer_draft"
    };
  });
  ...
  return {
    mode,
    output_strategy: autoPublishAllowed
      ? "publish_all_resolved_fields"
      : writerDraft.can_render === true
