...
function evidenceSources(field = {}) {
...
export function evidenceDocumentToIdentityEvidenceItems(evidenceDocument = {}, {
  ...
  Object.entries(evidence).forEach(([fieldName, field]) => {
    ...
    const sources = evidenceSources(field);
...
export function applyIdentityResolutionGate(result = {}, {
  ...
  return {
    ...
    confidence: confidenceForIdentityStatus(identityResolution.status),
    ...
    title_length_policy: canRenderFinalTitle ? presentation.title_length_policy : result.title_length_policy,
    resolution_trace: [
