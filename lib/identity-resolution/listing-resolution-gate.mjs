...
function identityResolutionGateInput(result = {}, {
  ...
  const applicationEvidenceItems = applicationOwnsCandidates
    ...
    : [];
  const worldKnowledgeEvidenceItems = result.world_knowledge?.enabled === true
    && Array.isArray(result.world_knowledge.identity_evidence_items)
  ...
  const evidenceItems = [...directEvidenceItems, ...applicationEvidenceItems, ...worldKnowledgeEvidenceItems];
  ...
  return {
    ...
    retrievalEvidenceIsolation: {
      ...
      policy: "raw_retrieval_candidate_evidence_blocked; application_field_evidence_only",
      direct_evidence_item_count: directEvidenceItems.length,
      application_evidence_item_count: applicationEvidenceItems.length,
      world_knowledge_evidence_item_count: worldKnowledgeEvidenceItems.length,
