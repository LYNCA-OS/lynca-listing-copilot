...
export function canonicalizeIdentityEvidence(input = {}) {
  ...
  return {
    ...
    normalization_policy: {
      ...
      source_priority: "SLAB_LABEL > CARD_BACK_PRINTED_TEXT > CARD_FRONT_PRINTED_TEXT > INTERNAL_APPROVED_HISTORY > OFFICIAL_CHECKLIST > STRUCTURED_DATABASE > AGNES_INFERENCE > OCR_ONLY > MARKETPLACE > VISUAL_GUESS",
