...
export async function requireTenantAccess(req, {
  ...
  const context = buildUserContext(membership, requestId, session.email);
...
export function requireWorkerContext(req, { job, env = process.env } = {}) {
  ...
  const supplied = headerValue(req, internalServiceSecretHeader);
...
export { internalServiceSecretHeader as workerSecretHeader };
