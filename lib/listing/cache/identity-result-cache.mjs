...
export function isCacheableIdentityResult(result = {}, {
  ...
  // resolved_fields is the terminal Identity Resolver / presentation owner.
  // result.resolved can still be the pre-finalization provider snapshot.
...
export function identityResultToCacheRow({
  ...
  return {
    ...
    row: {
      ...
      evidence_snapshot: {},
      identity_resolution: reusableCacheValue(result.identity_resolution || null),
