...
export const ocrRendezvousRuntimePolicyVersion = "ocr-rendezvous-runtime-policy-v3-unavailable-short-circuit";
...
export function buildRecognitionPipelineFingerprint(payload = {}, env = process.env) {
  ...
  const ownerVersions = Object.freeze({
    ...
    evidence: Object.freeze({
      owner_version: evidenceSchemaOwnerVersion,
