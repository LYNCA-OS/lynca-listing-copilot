...
import { providerModelPinning, visionProviderIds } from "../providers/provider-contract.mjs";
import {
  ...
  if (openai.enabled && openai.configured) {
    ...
    return component({
      ...
      details: {
        ...
        model_pinning: providerModelPinning(visionProviderIds.OPENAI_LEGACY, env)
      }
    });
  }
