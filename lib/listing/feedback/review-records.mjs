...
export function buildListingReviewRecords({
  ...
  const analysisRun = {
    ...
    generated_evidence: sanitizeJson(payload.generated_evidence || payload.generatedEvidence || payload.evidence, {}),
    ...
    retrieval_trace: sanitizeJson(payload.retrieval_trace || payload.retrievalTrace || payload.retrieval, {}),
