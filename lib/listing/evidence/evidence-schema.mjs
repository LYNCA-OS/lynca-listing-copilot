...
import { sanitizeIdentityCardNameValue, sanitizeIdentitySetValue } from "../pipeline/text.mjs";
...
export function normalizeResolvedFields(input = {}) {
  ...
  return {
    ...
    set: sanitizeIdentitySetValue(raw.set || raw.set_or_insert),
    ...
    card_name: sanitizeIdentityCardNameValue(raw.card_name || raw.cardName || raw.name),
