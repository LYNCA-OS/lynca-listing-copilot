import { compactSubjectNames, normalizeComparable, titleCleanup } from "./title-cleanup.mjs";
...
export function fitTitleItems(items, {
  ...
  let current = removeDuplicateItems(cloneItems(items).map((item, originalIndex) => ({
    ...item,
    originalIndex
  })));
