...
function titleItems(resolved, {
  ...
  const productIdentity = productHierarchyText(resolved);
  ...
  return [
    ...
    { key: "product_identity", text: productIdentity, priority: 9, required: Boolean(productIdentity), compactable: true },
    { key: "subject", text: subject, priority: 3, required: Boolean(subject), compactable: true },
    { key: "card_name", text: cardName, priority: 12, required: Boolean(cardName), compactable: true },
