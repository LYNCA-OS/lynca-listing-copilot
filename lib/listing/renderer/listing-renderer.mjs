...
function lotQuantityText(resolved = {}) {
  ...
  // One token, never "Lot x3" -- a split marker matches no buyer search.
  // The separator is `*`, decided by the founder 2026-08-08. The reviewed
  // writer corpus spells it `lotx3`, and that describes what writers have
  // typed rather than what the marker is; the contract decides the marker.
  return count > 1 ? `Lot*${count}` : "Lot";
}
