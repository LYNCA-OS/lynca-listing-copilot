...
function pokemonItems(resolved) {
  ...
  const serialLimit = serialLimitText(resolved.numerical_rarity, { oneOfOne: resolved.one_of_one });
  ...
  return [
    ...
    { key: "language", text: language, priority: 2, compactable: false },
    ...
    { key: "additional_info", text: cardNumber, priority: 26, compactable: false },
