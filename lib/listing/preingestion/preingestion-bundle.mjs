...
// v20 refreshes the immutable OCR audit record after effective backend
// provenance became part of the contract. v19 text remains available for
// replay, but cannot masquerade as Paddle when Google Vision produced it.
export const preingestionOcrJobVersion = "ocr-crop-v20";
