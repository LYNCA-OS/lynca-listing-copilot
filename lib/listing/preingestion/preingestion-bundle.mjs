...
// v22 moves the sparse serial scan off the brittle bottom-right assumption and
// selects the slab reverse while preserving one OCR request per field/card.
export const preingestionOcrJobVersion = "ocr-crop-v22";
