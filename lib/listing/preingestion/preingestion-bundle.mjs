...
// Queue ingress must not trust a browser-supplied bundle id. Resolve the most
// recent durable bundle from the same tenant + asset generation instead, no
// matter whether it was created by background preparation or an explicit
// pre-ingestion request.
