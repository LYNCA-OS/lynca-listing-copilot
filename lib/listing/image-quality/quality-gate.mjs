...
export const defaultCaptureProfile = Object.freeze({
  ...
  critical_regions: Object.freeze({
    ...
    // Limited numbering has no reliable bottom-right convention. It commonly
    // appears anywhere along the right side of a raw card, and near the upper
    // right of a slabbed card's reverse. Keep this bounded to the card's main
    // numbering band; the OCR verifier still requires exact/expanded-crop
    // agreement before a numerator is trusted.
    serial_number: { x: 0.50, y: 0.18, width: 0.48, height: 0.68 },
