...
export const defaultCaptureProfile = Object.freeze({
  ...
  critical_regions: Object.freeze({
    ...
    // Limited numbering commonly sits in the right-side upper/middle band on
    // both raw fronts and slab reverses. A tall right-half scan made the token
    // too small for focused OCR and spent pixels on unrelated lower-card text.
    // The crop planner adds a 6% safety margin around this signal-dense band.
    serial_number: { x: 0.50, y: 0.20, width: 0.44, height: 0.32 },
