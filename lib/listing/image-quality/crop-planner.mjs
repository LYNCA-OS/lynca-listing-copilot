// REGION CROPS FOR RECOGNITION: measured twice, rejected twice. 2026-08-05.
//
// This planner serves image quality. It is NOT a route to better recognition,
// and the temptation to reach for it from that direction has a measurement:
//
//   bottom-band crop, 105 cards   +0.0048, 27W/19L, p=0.302
//                                 latency +47%, input tokens +24%
//
// The obvious redesigns do not survive their ceilings either. Aimed at
// `card_number`, a perfect answer is worth +0.000000 -- a card number appears
// in 3 of 150 reviewed titles and 0 of 105, because writers do not publish it.
// Aimed at `print_finish`, which has the largest field ceiling at +0.036, only
// the "saw it and judged it wrong" half is croppable and that half averages
// +0.0068 against measured drift of 0.009. Below drift means a PERFECT crop
// could not be told apart from running the same arm twice.
//
// The two cohorts also disagree six-fold on how many cards are croppable at all
// -- 18 against 3 -- so designing around either branch fits one cohort.
//
