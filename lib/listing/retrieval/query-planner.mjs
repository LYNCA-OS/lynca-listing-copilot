...
function addCatalogFirstQueries(planned, fields, {
  ...
  // the product downstream. Gated to a secondary anchor (serial/year/set) to
  // avoid pure-subject noise on common names.
  if (subject && (serialDenom || fields.year || fields.insert || fields.set || fields.subset)) {
