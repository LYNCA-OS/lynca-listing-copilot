...
function addCatalogFirstQueries(planned, fields, {
  ...
  if (fields.product || fields.set || fields.card_name || fields.insert) {
...
export function planRetrievalQueries({
  ...
  const serialDenom = fields.expected_serial_denominator || serialDenominator(fields.serial_number);
  const planned = [];
