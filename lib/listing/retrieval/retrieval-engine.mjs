...
function catalogRetrievalMetrics({
  ...
  const isOfficialChecklistSource = (sourceType = "") => /_OFFICIAL_CHECKLIST$/i.test(String(sourceType || ""));
  ...
  const sourceBreakdown = catalogCandidates.reduce((acc, candidate) => {
    ...
    if (sourceType === "LEAF_OFFICIAL_CHECKLIST") acc.source_breakdown_leaf_official += 1;
