...
function candidatesFromRows(rows = [], query = {}) {
  ...
  return normalizedRows.map((row, index) => {
    ...
    return {
      ...
      reference_metadata: {
        ...referenceMetadata,
        retrieval_status: temporaryGt
          ? "approved"
          : cleanText(row.retrieval_status || referenceMetadata.retrieval_status || ""),
        reference_status: temporaryGt
          ? "APPROVED"
          : cleanText(row.reference_status || referenceMetadata.reference_status || ""),
      ...
      field_derivation: {
        ...
        title_derived_fields_are_ground_truth: temporaryGt,
        corrected_title_as_temporary_gt: temporaryGt,
        temporary_ground_truth_source: temporaryGt ? "corrected_title" : ""
      }
    };
