...
function candidatesFromRows(rows = [], query = {}) {
  ...
  const approvedOnlyResultSet = query.include_candidate_identities !== true;
  ...
  return normalizedRows.map((row, index) => {
    ...
    return {
      ...
      reference_metadata: {
        ...referenceMetadata,
        retrieval_status: cleanText(row.retrieval_status || referenceMetadata.retrieval_status || (approvedOnlyResultSet ? "approved" : "")),
