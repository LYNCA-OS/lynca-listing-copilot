...
export function vectorRetrievalConfig(env = process.env, options = {}) {
  ...
  return {
    ...
    queryTimeoutMs: optionInteger(options, ["vector_query_timeout_ms", "vectorQueryTimeoutMs"], positiveInteger(env.VECTOR_QUERY_TIMEOUT_MS || env.VISUAL_VECTOR_RETRIEVAL_TIMEOUT_MS, 8000)),
