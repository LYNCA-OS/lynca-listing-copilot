...
export const providerDisplayNames = Object.freeze({
  ...
  [visionProviderIds.CASCADE_FAST]: "GPT-4.1 Primary + Agnes Assist"
});

export const providerLabels = Object.freeze({
  [visionProviderIds.CASCADE_FAST]: "GPT-4.1 优先 · Agnes 辅助",
  [visionProviderIds.AGNES]: "Agnes · 辅助复核",
  [visionProviderIds.OPENAI_LEGACY]: "GPT-4.1 · 单模型手动"
});
