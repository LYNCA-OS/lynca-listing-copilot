...
const costEnvKeys = Object.freeze({
  [visionProviderIds.AGNES]: {
    input: ["AGNES_INPUT_TOKEN_COST_PER_1M", "AGNES_PROMPT_TOKEN_COST_PER_1M"],
    output: ["AGNES_OUTPUT_TOKEN_COST_PER_1M", "AGNES_COMPLETION_TOKEN_COST_PER_1M"],
    image: ["AGNES_IMAGE_COST_USD"]
  },
...
export function normalizeProviderUsage({
  ...
  return {
    ...
    prompt_tokens: usageNumber(usage, ["prompt_tokens"]),
    completion_tokens: usageNumber(usage, ["completion_tokens"]),
