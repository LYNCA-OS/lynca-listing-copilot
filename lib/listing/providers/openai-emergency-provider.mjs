...
const openAiModelEvidenceSourceTypes = Object.freeze([
  "",
  "NONE",
  "CARD_FRONT",
  "CARD_FRONT_TEXT",
      ...
      field_evidence: {
        ...
        items: {
          ...
          properties: {
            ...
            source_type: { type: "string", enum: [...openAiModelEvidenceSourceTypes] },
    ...
    e: {
      ...
      items: {
        ...
        properties: {
          ...
          s: { type: "string", enum: [...openAiModelEvidenceSourceTypes] },
          i: { type: "string" },
          t: { type: "string" }
        },
        required: ["f", "v", "s", "i", "t"]
...
function openAiStrictSchemaPrompt(prompt = "", {
  ...
  return [
    ...
    ...transportRules,
    "source_type is model-reported provenance only. Never emit OPERATOR, HUMAN_OPERATOR, or MANUAL_OPERATOR; operator provenance is added only by a server-issued envelope after the model response.",
