...
function openAiStrictSchemaPrompt(prompt = "", {
  ...
  return [
    ...
    // The colour list is a cap on what can ever be said: a colour named here
    // and nowhere else is discarded downstream. It is kept in step with
    // surfaceColorTokens in lib/listing/parallel-policy.mjs -- production read
    // teal, sapphire, rainbow, holo and multicolor and lost every one of them
    // because both lists stopped at eight.
    "Use surface_color for the visual colour: Gold/Purple/Red/Blue/Green/Silver/Black/Orange/Pink/Yellow/Bronze/Copper/Teal/Aqua/Sapphire/Rainbow/Holo/Holographic/Multicolor/Camo. Do not infer exact optical parallels such as Gold Refractor, Wave, Shimmer, Mojo, Prizm, Sparkle, or Holo from appearance alone.",
    compact
