...
export function openAiProviderRequestDiagnostics({
  ...
  return {
    ...
    requested_output_cap: Number.isFinite(Number(tokenDiagnostics.requested_output_cap)) ? Number(tokenDiagnostics.requested_output_cap) : null,
    output_cap: Number.isFinite(Number(tokenDiagnostics.output_cap)) ? Number(tokenDiagnostics.output_cap) : null,
    model_output_token_cap: Number.isFinite(Number(tokenDiagnostics.model_output_token_cap)) ? Number(tokenDiagnostics.model_output_token_cap) : null,
