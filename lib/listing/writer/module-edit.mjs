...
function moduleFieldNames(moduleKey) {
  return {
    ...
    release_variant: ["official_card_type", "insert", "surface_color", "parallel_exact", "parallel", "variation", "subset"],
    print_finish: ["parallel_family", "parallel", "variation"],
    numerical_rarity: ["serial_number", "one_of_one"],
