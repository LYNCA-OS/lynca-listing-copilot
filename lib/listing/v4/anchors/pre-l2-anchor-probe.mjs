import { preingestionEvidenceDocumentFromPayload } from "../../pipeline/preingestion-evidence.mjs";
...
export async function probePreL2Anchors({
  ...
  const result = {
    schema_version: "v4-pre-l2-anchor-probe-v2",
    canonical_evidence_schema_version: evidenceDocument.schema_version || null,
    dossier,
    plan,
  ...
  const finalize = await maybeFinalizeL1FromExactAnchor({
    scoutResult: {
      ...
      canonical_evidence_document: evidenceDocument,
      current_image_context: payload,
