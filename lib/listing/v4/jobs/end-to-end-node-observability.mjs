...
export function buildEndToEndNodeLedger({
  ...
  const deterministicTitleSource = /^(?:identity_resolution_deterministic_renderer|v4_csm_deterministic_renderer|deterministic_renderer_finalizer|exact_anchor_catalog_finalized|pre_l2_anchor_catalog_finalized)$/.test(titleRenderSource);
  ...
  const checks = [
    ...
    ...(writerReady && !writerReviewRequired ? [{
      ...
      severity: "ERROR",
      expected: "identity_resolution_deterministic_renderer or another deterministic CSM renderer",
