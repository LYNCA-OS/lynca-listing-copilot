...
import {
  ...
  providerTerminalPathPolicy
} from "./provider-terminal-path-policy.mjs";
...
export const v4ProductionStrategyProfile = Object.freeze({
  ...
  candidate_control_policy_version: candidateSelectionHeuristicVersion,
  provider_terminal_path_policy_id: providerTerminalPathPolicy.policy_id,
  provider_terminal_path_policy_version: providerTerminalPathPolicy.policy_version,
...
export const v4ProductionStrategy = Object.freeze({
  ...
  candidate_control: Object.freeze({
    build_pre_application_evidence_snapshot: buildCandidatePreApplicationEvidenceSnapshot,
  ...
  provider_terminal: Object.freeze({
    plan_after_provider: planProviderTerminalPath
  }),
