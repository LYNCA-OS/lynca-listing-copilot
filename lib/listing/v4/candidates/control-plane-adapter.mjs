...
export function buildV4CandidateControlPlaneTrace(result = {}) {
  ...
  return {
    ...
    decision_eligible_candidate_ids: Array.isArray(result.decision_eligible_candidate_ids)
      ...
      : [],
    field_evidence_eligible_candidate_count: Number(result.field_evidence_eligible_candidate_count || 0),
    field_evidence_eligible_candidate_ids: Array.isArray(result.field_evidence_eligible_candidate_ids)
      ? result.field_evidence_eligible_candidate_ids
      : [],
