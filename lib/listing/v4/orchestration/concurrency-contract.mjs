...
export function contractedConcurrency(stage, requested, { fallback = 1 } = {}) {
  ...
  return Math.max(1, Math.min(normalized, Number(config.concurrency || fallback || 1)));
}
