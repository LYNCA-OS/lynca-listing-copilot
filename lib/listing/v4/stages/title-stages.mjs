...
export function buildV4TitleStageState({
  ...
  const state = {
    title_stage: stage,
    writer_safe_draft: failed || internalScout ? "" : (writerSafeReady || title ? title : ""),
    assisted_draft: failed || internalScout ? null : (assisted ? title : null),
    assisted_draft_status: failed ? "FAILED" : internalScout ? "PENDING" : (assisted ? "READY" : "PENDING"),
    assisted_draft_pending_modules: failed ? routePlan.background_modules || [] : assisted ? [] : routePlan.background_modules || [],
