...
export function buildV4TitleStageState({
  ...
  const state = {
    title_stage: stage,
    writer_safe_draft: internalScout ? "" : (writerSafeReady || title ? title : ""),
    assisted_draft: internalScout ? null : (assisted ? title : null),
    assisted_draft_status: internalScout ? "PENDING" : (assisted ? "READY" : "PENDING"),
