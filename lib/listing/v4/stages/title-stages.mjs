...
export function buildV4ModuleSpeedMetrics({ result = {}, routePlan = {}, stageState = {} } = {}) {
  ...
  return {
    ...
    time_to_l1_safe_draft_ms: internalScout ? null : (timingValue(timing, "time_to_l1_safe_draft_ms", "total_ms") ?? observedTotal),
...
export function buildV4TitleStageState({
  ...
  const state = {
    ...
    readiness: {
      ...
      writer_visible_title_ready: !internalScout && writerSafeReady
    }
  };
