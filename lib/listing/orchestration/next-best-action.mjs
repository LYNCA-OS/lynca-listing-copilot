...
export const completionActions = Object.freeze({
  ...
  CROP_AND_READ_PARALLEL: "CROP_AND_READ_PARALLEL",
...
const regionRecoveryActions = Object.freeze({
  ...
  surface_color: completionActions.CROP_AND_READ_PARALLEL,
  parallel_family: completionActions.CROP_AND_READ_PARALLEL,
  parallel_exact: completionActions.CROP_AND_READ_PARALLEL,
  parallel: completionActions.CROP_AND_READ_PARALLEL,
  variation: completionActions.CROP_AND_READ_PARALLEL
});
...
const actionInformationGain = Object.freeze({
  ...
  [completionActions.CROP_AND_READ_PARALLEL]: 0.71,
...
export function chooseNextBestAction({
  ...
  const retrievalCandidate = firstAvailable(attemptedActions, [
    ...
    },
    {
      ...
      condition: hasProductAnchor(resolved)
        || Boolean(resolved.insert || resolved.surface_color || resolved.parallel_family || resolved.parallel_exact || resolved.parallel || resolved.checklist_code)
    },
    {
  ...
  if ((state.critical_region_occlusion || []).length && !hasAttemptedAction(attemptedActions, completionActions.REQUEST_TARGETED_RESCAN)) {
    return decision(completionActions.REQUEST_TARGETED_RESCAN, "Critical region remains occluded after focused recovery and retrieval constraints.");
  }
