...
export function attachFieldTaskOrchestration(result = {}, {
  ...
  return {
    ...
    timing: {
      ...
      time_to_first_field_ms: orchestration.timing.time_to_first_field_ms,
      time_to_core_identity_ms: orchestration.timing.time_to_core_identity_ms,
      time_to_writer_draft_ms: orchestration.timing.time_to_writer_draft_ms,
      time_to_final_assisted_title_ms: orchestration.timing.time_to_final_assisted_title_ms,
      per_task_latency_ms: orchestration.timing.per_task_latency_ms,
      field_task_timing_estimation: orchestration.timing.timing_estimation
    }
  };
}
