...
export const legacyXlsChecklistParserVersion = `${officialChecklistParserVersion}:legacy-xls-v1`;
...
function parseToppsUfcSparseWorkbookRows(lines = [], {
  ...
  lines.forEach((line, index) => {
    ...
    const section = sectionInfo(currentFamily === "BASE"
      ? currentSection
      : [currentFamily, currentSection].filter(Boolean).join(" "));
