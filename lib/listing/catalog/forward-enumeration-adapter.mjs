...
export function forwardEnumerationCandidatePacketForResult(result = {}, model = null) {
  return buildForwardEnumerationCandidatePacket(observedClaim(result), model);
}

export function forwardEnumerationTraceForResult(result = {}, model = null) {
  return forwardEnumerationCandidatePacketForResult(result, model).trace;
}
...
export function attachForwardEnumerationCandidates(result = {}, model = null, { shadow = true } = {}) {
  const packet = forwardEnumerationCandidatePacketForResult(result, model);
...
export function mergeForwardEnumerationApplicationEvidence(result = {}, application = {}) {
  ...
  const forwardItems = forward?.forward_enumeration_adapter_version === forwardEnumerationAdapterVersion
    && Array.isArray(forward.identity_evidence_items)
    ? forward.identity_evidence_items
    : [];
