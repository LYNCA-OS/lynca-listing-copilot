...
function provenance(model = {}, ruleId = "") {
  ...
  return Object.freeze({
    ...
    source_sha256: cleanText(model.snapshot_source_sha256) || null,
    rule_id: ruleId,
...
export function buildForwardEnumerationCandidatePacket(claim = {}, model = null) {
  ...
  return Object.freeze({
    ...
    constraint_snapshot_version: cleanText(model?.snapshot_version || model?.schema_version || model?.version) || null,
    constraint_snapshot_source_sha256: cleanText(model?.snapshot_source_sha256) || null,
