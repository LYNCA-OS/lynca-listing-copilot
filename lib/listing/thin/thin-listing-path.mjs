...
import { providerReasoningEffortReceipt } from "./provider-response-attestation.mjs";
 ...
 */
export function finishCanonicalTitle(payload, { limit, exactParallelColorCompaction } = {}) {
  ...
  const composed = composeFromCanonicalFields(cleaned, composeOptions);
  return {
    title: composed.title,
    fields: cleaned,
