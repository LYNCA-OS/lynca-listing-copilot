...
export function finishCanonicalFields(fields, {
  ...
  const mandatorySubjectMissing = cleaned.grammar !== "lot" && cleaned.subjects.length === 0;
  return {
...
export async function runCanonicalListingPath({
  ...
  return {
    ...
    // This is the final post-resolution contract. The parsed provider receipt
    // remains immutable: resolver-issued relations are not provider evidence.
