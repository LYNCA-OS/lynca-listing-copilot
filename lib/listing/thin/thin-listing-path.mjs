...
export function finishCanonicalFields(fields, {
  ...
  return {
    title: mandatorySubjectMissing ? "" : composed.title,
    fields: cleaned,
    ...
    canonical_naming_publishable: !mandatorySubjectMissing
      && composed.canonical_naming_publishable !== false,
    canonical_naming_failure_code: mandatorySubjectMissing
    ...
    length: mandatorySubjectMissing ? 0 : composed.length
  };
}
