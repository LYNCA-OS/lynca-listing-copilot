 ...
 */
export async function runCanonicalListingPath({ imageUrls, model, effort = "none", callProvider }) {
  const startedAt = Date.now();
  const response = await callProvider(buildCanonicalFieldsRequest({ imageUrls, model, effort }));
