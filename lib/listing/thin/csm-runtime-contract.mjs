...
import { activeWriterProjectionContract } from "./csm-projection-activation.mjs";
...
export const CSM_THIN_RUNTIME_CONTRACT = Object.freeze({
  ...
  promptVersion:
    ACTIVE_WRITER.canonical_fields.semantic_prompt_version,
  estimatedTokensPerAttempt: CSM_ACTIVE_MODEL_PROFILE.estimated_tokens_per_attempt,
  localFallbackConcurrency: 6,
  retryPolicy: ACTIVE_WRITER.provider_dispatch.retry_policy,
  maximumAttempts: ACTIVE_WRITER.provider_dispatch.maximum_attempts,
  ...(ACTIVE_WRITER.provider_dispatch.durable_transport_retry_receipt ? {
    semanticResultLimit: 1,
    automaticTransportRetryLimit: 1,
    automaticTransportRetryPolicy: "definitive-complete-http-502-no-output-no-token-v1"
  } : {}),
  claimPollMs: 1_000,
