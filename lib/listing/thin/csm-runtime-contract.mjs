...
if (CSM_ACTIVE_MODEL_PROFILE.transport_profile_id !== CSM_STAGED_TRANSPORT_PROFILE.id) {
  throw new TypeError("active_model_transport_profile_mismatch");
}
...
export const CSM_THIN_RUNTIME_CONTRACT = Object.freeze({
  ...
  transportProfileId: CSM_ACTIVE_MODEL_PROFILE.transport_profile_id,
