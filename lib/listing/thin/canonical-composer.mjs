...
// Two different cards' answers joined into one value. The model writes "; "
// when a lot shows it two of something; "/" is excluded deliberately, since a
// serial and a card number both legitimately contain one.
const PER_CARD_SEPARATOR = /;\s|\s\|\s/;
