...
function renderBracket(name, fields, {
  ...
  switch (name) {
    ...
    case "grading_info":
      return fields.grade || renderGradingInfo(fields.grading_info) || "";
    case "card_number":
...
export function composeFromCanonicalFields(fields, {
  ...
  const useDurableLotSharedOnly = features.durable_lot_terminal_shared_only !== false;
  const usePublicationCoverage = features.publication_coverage !== false;
