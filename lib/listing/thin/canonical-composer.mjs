...
export const DROP_ORDER = Object.freeze({
  standard: Object.freeze(["card_number", "release_variant", "year", "manufacturer",
    "observable_components", "descriptive_rarity", "set", "print_finish", "card_name", "product"]),
  // TCG keeps its card number: it identifies the exact card within a set.
  tcg: Object.freeze(["release_variant", "year", "manufacturer", "observable_components",
    "descriptive_rarity", "set", "print_finish", "card_name", "product"]),
  lot: Object.freeze(["year", "extra_subjects", "observable_components", "release_variant",
    "print_finish", "card_name", "manufacturer_product"])
});
