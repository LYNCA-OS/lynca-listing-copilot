...
// Founder Beta v0.3 changes display order only. Set remains the container,
// Card Name renders before Subject, and Subject keeps its v0.1/v0.2 mandatory
// identity constraint and selection priority. The active writer remains v0.2
// until a separate projection activation selects this profile.
