...
export const CANONICAL_FIELDS_PROMPT_VERSION = "csm-canonical-fields-v1";
...
export function parseCanonicalFields(raw) {
  ...
  // admission layer returned early on one. COS-39's grammar boundary can, and
  // its own example ("Gold Refractor" on a Charizard) is a printed name, so
