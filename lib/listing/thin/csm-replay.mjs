...
function composeLyncaStandardReplay(fields) {
  ...
  return composeLyncaStandardName(fields);
}
...
const COMPOSER_DISPATCH = Object.freeze({
  ...
  [THIN_COMPOSER_VERSION]: Object.freeze({
    [LYNCA_STANDARD_PROFILE_VERSION]: composeLyncaStandardReplay
  }),
...
function canonicalNamingTraceProblems(rows, replayed) {
  ...
  if (output?.composer_version !== THIN_COMPOSER_VERSION
      || output?.marketplace_profile_version !== LYNCA_STANDARD_PROFILE_VERSION) return [];
