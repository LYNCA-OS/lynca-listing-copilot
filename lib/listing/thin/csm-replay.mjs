...
function composeLyncaStandardReplay(fields, marketplaceProfileVersion) {
  ...
  return composeLyncaStandardNameForProfile(fields, { marketplaceProfileVersion });
}
...
const COMPOSER_DISPATCH = Object.freeze({
  ...
  [THIN_COMPOSER_VERSION]: Object.freeze({
    [LYNCA_STANDARD_PROFILE_VERSION_V1]: (fields) => composeLyncaStandardReplay(
      fields, LYNCA_STANDARD_PROFILE_VERSION_V1
    ),
    [LYNCA_STANDARD_PROFILE_VERSION_V2]: (fields) => composeLyncaStandardReplay(
      fields, LYNCA_STANDARD_PROFILE_VERSION_V2
    )
  }),
