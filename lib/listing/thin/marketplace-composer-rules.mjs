...
export const MARKETPLACE_PROFILES = Object.freeze({
  ...
  // A field is not projected merely because it looks commercially useful.
  // This profile is selected only after the external-identity resolver has
  // produced an exact, unique, source-versioned receipt for the same release
  // and checklist identity.  Keeping it separate from `ebay` makes disabling
  // the enrichment pack byte-identical to the measured baseline.
  ebayVerifiedExternalIdentity: Object.freeze({
