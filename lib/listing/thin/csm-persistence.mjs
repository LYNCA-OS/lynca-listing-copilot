...
export const LYNCA_STANDARD_PROFILE_VERSION = LYNCA_STANDARD_PROFILE_VERSION_V2;
...
export function buildCsmStageRows({
  ...
  const verifiedCanonicalNamingProfileVersion =
    VERIFIED_ORIGINAL_OBSERVATION_RESOLUTION_CONTRACT
    ...
    if (verifiedOriginalSupported) {
      ...
      if (!verifiedOriginalCorroborated) {
        const reviewedCandidateId = rowId(
          ...
          CSM_STAGE_CONTRACT_VERSION, verifiedOriginalObservationSupport.release_id,
          contentDigest({
