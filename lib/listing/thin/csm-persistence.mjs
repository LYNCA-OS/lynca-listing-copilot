...
import { validateFounderBetaWebReceipt } from "./csm-forward-reader-bridge.mjs";
...
export function buildCsmStageRows({
  ...
  if (durableProjectionContract) {
    if (founderBetaWebReceipt != null) {
      try { validateFounderBetaWebReceipt(founderBetaWebReceipt); }
      catch { throw new TypeError("founder_beta_web_receipt_invalid"); }
    }
    if (setCardNameRelationReceipt != null) {
      try { validateSetCardNameRelationReceipt(setCardNameRelationReceipt, fields); }
