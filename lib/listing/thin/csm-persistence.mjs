...
export const LYNCA_STANDARD_PROFILE_VERSION = "lynca-standard-name-v0.1";
...
export function buildCsmStageRows({
  ...
  const ordinaryCompositionPairValid = (
    ...
    ordinaryComposerVersion === THIN_COMPOSER_VERSION
      && ordinaryProfileVersion === LYNCA_STANDARD_PROFILE_VERSION
  ...
  const resolutionId = rowId(
    ...
    externalApplied ? externalReplayRelease.resolution.resolver_version : THIN_RESOLVER_VERSION,
