 ...
 */
export function toResolvedFields(fields = {}, { capturedE1ae = false } = {}) {
  ...
  return {
    ...
    // The captured production writer predates these two direct SEM lanes and
    // only carried the historical First Bowman alias. Its durable bytes must
    // stay frozen; the future writer retains the complete current mapping.
    ...(capturedE1ae ? {
