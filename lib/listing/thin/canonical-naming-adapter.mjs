...
if (LYNCA_STANDARD_PROFILE_VERSION !== LYNCA_STANDARD_PROFILE_VERSION_V3) {
...
// Activation A switches only fresh Standard writes. V1/V2 remain immutable
// stored-version replay contracts.
export const CANONICAL_NAMING_RELEASE_CONTRACT = CANONICAL_NAMING_RELEASE_CONTRACT_V3;
