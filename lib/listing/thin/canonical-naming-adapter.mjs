...
import { publicationCoverageFromCanonicalNamingTrace } from "./publication-coverage.mjs";
...
if (LYNCA_STANDARD_PROFILE_VERSION !== LYNCA_STANDARD_PROFILE_VERSION_V2) {
...
export const CANONICAL_NAMING_RELEASE_CONTRACT_V3 = releaseContract(
  LYNCA_STANDARD_NAMING_PROFILE_V03,
  LYNCA_STANDARD_PROFILE_VERSION_V3
);

// The atomic projection activation switched the fresh writer to v0.2. Keep V1
// exported as an immutable stored-version replay contract.
export const CANONICAL_NAMING_RELEASE_CONTRACT = CANONICAL_NAMING_RELEASE_CONTRACT_V2;
...
export function composeLyncaStandardNameForProfile(fields, {
  ...
  return {
    ...
    ...(publicationCoverage ? {
      publication_coverage: publicationCoverageFromCanonicalNamingTrace(result.trace)
    } : {}),
