...
// Additive v1 field: historical v1 receipts omit it and remain replayable;
// new executions persist either null (attempt 1/manual retry) or the sealed
// definitive-502 predecessor receipt. Its presence is explicitly hashed.
