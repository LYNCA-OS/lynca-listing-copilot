...
import { CSM_STAGED_TRANSPORT_PROFILE } from "./csm-recognition-transport.mjs";

export { CSM_STAGED_TRANSPORT_PROFILE } from "./csm-recognition-transport.mjs";
...
if (CSM_STAGED_TRANSPORT_PROFILE.lane_version !== STAGED_RECOGNITION_LANE_VERSION
    || CSM_STAGED_TRANSPORT_PROFILE.recognition_long_edge !== STAGED_RECOGNITION_LONG_EDGE
    || CSM_STAGED_TRANSPORT_PROFILE.recognition_max_body_bytes
      !== STAGED_RECOGNITION_MAX_BODY_BYTES) {
  throw new TypeError("staged_transport_lane_version_mismatch");
}
