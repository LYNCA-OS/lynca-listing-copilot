...
export const CSM_STAGED_TRANSPORT_PROFILE = Object.freeze({
  id: "staged-readability-derived-v2",
  lane_version: STAGED_RECOGNITION_LANE_VERSION,
  recognition_role: STAGED_RECOGNITION_ROLE,
  recognition_long_edge: STAGED_RECOGNITION_LONG_EDGE,
  recognition_max_body_bytes: STAGED_RECOGNITION_MAX_BODY_BYTES,
  original_durability: "required_before_title",
  overlap: "derived_provider_with_original_upload"
});
