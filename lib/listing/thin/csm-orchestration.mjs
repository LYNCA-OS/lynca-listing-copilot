...
export function resolveCanonicalObservation(observation, { externalIdentityContext = null } = {}) {
  const resolution = resolveExternalIdentitySupport(observation?.fields || {}, {
