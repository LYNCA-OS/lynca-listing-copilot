...
export function componentQualityReport(results = [], {
  ...
  return {
    ...
    corrected_title_is_proxy_only: false,
    ...
    factors: {
      evidence_recall: {
        ...
        title_ground_truth_value: average(comparisons.map((item) => item.token_recall)),
        proxy_source: "legacy_alias_corrected_title_token_recall",
        title_ground_truth_source: "supabase_corrected_title",
