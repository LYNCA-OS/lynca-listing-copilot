export const noFullProviderLatencyEnvelopeVersion = "no-full-provider-latency-envelope-v1";
...
export function calculateNoFullProviderLatencyEnvelope({
  ...
  return deepFreeze({
    ...
    provider_calls: 0,
    formula: "max(original_upload_remaining, evidence_upload + focused_ocr) + compiled_lookup + candidate_control + resolver_renderer + commit_status",
