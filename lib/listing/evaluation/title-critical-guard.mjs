...
export const titleCriticalIdentityFields = Object.freeze([
  "year",
  "manufacturer",
  "product",
  "subject",
...
export function scoreTitleCriticalGuard({
  ...
  const expectedCriticalSem = Object.fromEntries(titleCriticalIdentityFields.map((field) => {
  ...
  const evaluatedFields = titleCriticalIdentityFields.filter((field) => (
...
export const __titleCriticalGuardTestHooks = Object.freeze({
  criticalIdentityFields: titleCriticalIdentityFields,
