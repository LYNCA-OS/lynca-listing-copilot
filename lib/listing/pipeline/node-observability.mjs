...
function providerTokenMetrics(result = {}) {
  ...
  return {
    ...
    // Sits beside the token counts on purpose: an effort sweep has to be able
    // to read the effort and the tokens it bought from the same record, or the
    // two can be joined wrongly.
    reasoning_effort: cleanText(result.provider_reasoning_effort) || null,
