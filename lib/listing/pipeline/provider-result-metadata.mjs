...
export function withProviderMetadata(result, providerResult, selection) {
  ...
  return {
    ...
    provider_slot_timing: providerResult.provider_slot_timing || null,
    ...
    provider_request_identity: providerResult.provider_request_identity || null,
    ...
    provider_output_cap_downgrade_attempted: providerResult.output_cap_downgrade_attempted === true,
    provider_output_cap_downgrade_attempts: Number(providerResult.output_cap_downgrade_attempts || 0),
