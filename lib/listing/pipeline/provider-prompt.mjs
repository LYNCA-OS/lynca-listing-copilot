...
export function compactV4L2RecognitionPrompt(payload, maxTitleLength) {
  ...
  return [
    ...
    "Front/back: use front subject/attributes; copy the complete back-printed product/set including league/sport qualifier and identity code. manufacturer/brand means the card publisher, never grader, team or legal prose. A checklist code is not product prose.",
