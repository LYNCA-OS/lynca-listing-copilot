...
export function compactV4L2RecognitionPrompt(payload, maxTitleLength) {
  ...
  return [
    ...
    "Extract visible facts: issue year; maker/product/set; all subjects; named segment; layout; basic color; supported finish; limited numbering; rarity; printed code; slab grade/attributes. Preserve product qualifiers and keep subjects out of card_name. Visible league logos/acronyms (MLS, UEFA, NBA, NFL, MLB) are product qualifiers; do not replace them with generic sport names.",
