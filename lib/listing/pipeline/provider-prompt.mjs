...
export function compactV4L2RecognitionPrompt(payload, maxTitleLength) {
  ...
  return [
    ...
    "Core: return visible year, product, set and subjects. An uncertain optional finish, code or rarity must never erase readable core facts. Year means issue year, never a retro design year: on an ungraded card, back text describing season N plus copyright N+1 means issue year N+1; a lone stats year is not the issue year.",
