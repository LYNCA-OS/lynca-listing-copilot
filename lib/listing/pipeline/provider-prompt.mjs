...
export function compactV4L2RecognitionPrompt(payload, maxTitleLength) {
  ...
  return [
    ...
    "Lot: multiple separate physical cards/slabs in an image => multi_card true and card_count equal to the visible count. Keep up to three subjects. Multiple subjects printed on one physical card are not a Lot.",
