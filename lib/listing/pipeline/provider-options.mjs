...
export function defaultProviderOptionsFromEnv(env = process.env) {
  ...
  return {
    ...
    v4_read_only_provider_contract: envFlag(env, "ENABLE_V4_READ_ONLY_PROVIDER_CONTRACT", false),
    v4_world_knowledge_proposals: envFlag(env, "ENABLE_V4_WORLD_KNOWLEDGE_PROPOSALS", false),
