...
export function normalizeFields(fields = {}) {
  ...
  const normalized = {
    ...
    set: normalizeIdentityTextOrNull(fields.set),
    ...
    insert: normalizeIdentityTextOrNull(rawInsertText),
    ...
    card_name: normalizeIdentityTextOrNull(fields.card_name || fields.cardName || fields.name),
