...
async function preingestItem({
  ...
  return {
    ...
    worker_jobs_attempted: response.data?.worker_jobs_attempted ?? null,
    ocr_dispatch_started: response.data?.ocr_dispatch_started === true,
...
export function resultFromBatchJob(prepared = {}, batchPoll = {}, thinkMs = 0) {
  ...
  return compactObject({
    ...
    preingestion_worker_jobs_attempted: preingestion.worker_jobs_attempted ?? null,
    preingestion_ocr_dispatch_started: preingestion.ocr_dispatch_started ?? null,
