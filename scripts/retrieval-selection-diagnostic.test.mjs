...
const report = buildRetrievalSelectionDiagnostic({
  dataset: { items: [{ id: "one", category: "baseball", retrieval_ground_truth: { accepted_identity_ids: ["truth"] }, reviewed_ground_truth: { field_statuses: {} } }] },
  audit: { cards: [{ query_card_id: "one", fields: { print_finish: { application_opportunity: true, application_correct: false } } }] },
