...
assert.match(factPrompt, /every emitted year, product and surface_color must have one short matching current-image field_evidence row/);
assert.match(factPrompt, /never inside a field value/);
...
assert.match(factPrompt, /several extracted subjects belong to separate visible rectangles/);
