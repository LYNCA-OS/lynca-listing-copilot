...
const outPath = arg("--out", "artifacts/candidate-expression-v4/development-150/identity-replay-v2.json");
...
const cards = rows.map((row) => {
  ...
  const replay = replayCandidateIdentityV2(row.fields, candidateByAsset.get(row.asset_id));
