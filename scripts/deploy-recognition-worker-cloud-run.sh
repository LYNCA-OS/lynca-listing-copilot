...
PADDLEOCR_MODEL_REVISION="${PADDLEOCR_MODEL_REVISION:-ppocr-v6-medium-hpi-cpu}"
PADDLEOCR_ROLE="${PADDLEOCR_ROLE:-shadow}"
PADDLEOCR_ENABLE_HPI="${PADDLEOCR_ENABLE_HPI:-true}"
PADDLEOCR_DETECTION_MODEL_NAME="${PADDLEOCR_DETECTION_MODEL_NAME:-PP-OCRv6_medium_det}"
PADDLEOCR_RECOGNITION_MODEL_NAME="${PADDLEOCR_RECOGNITION_MODEL_NAME:-PP-OCRv6_medium_rec}"
PADDLEOCR_CPU_THREADS="${PADDLEOCR_CPU_THREADS:-2}"
...
WORKER_REVISION="${RECOGNITION_WORKER_BUILD_REVISION:-${IMAGE_TAG}}"
...
printf 'RECOGNITION_WORKER_REVISION=%s\n' "$DEPLOYED_REVISION" >&2
