  ...
  scored as (
    select
      ...
      (
        ...
        case when p.yr_raw is not null
          and public.catalog_expand_years(c.season_year) && p.yr_set then 0.12 else 0 end +
      ...
      array_remove(array[
        ...
        case when p.yr_raw is not null
          and public.catalog_expand_years(c.season_year) && p.yr_set then 'year' end,
    ...
    where c.review_status in ('REVIEW_REQUIRED', 'REVIEWED_INTERNAL')
      ...
      and (
        ...
        or public.catalog_expand_years(c.season_year) && p.yr_set
      )
      and (
