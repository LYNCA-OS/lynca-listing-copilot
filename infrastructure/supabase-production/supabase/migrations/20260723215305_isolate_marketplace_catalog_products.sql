  ...
  loop
    ...
    if v_isolated_product_id is null then
      insert into public.catalog_products (
        sport, league, season_year, manufacturer, brand, product,
        source_id, source_status, review_status, metadata
      )
      select
        original.sport, original.league, original.season_year,
        original.manufacturer, original.brand, original.product,
        v_pair.marketplace_source_id, 'REVIEW_REQUIRED', 'REVIEW_REQUIRED',
