...
begin
  ...
  insert into public.v4_writer_feedback_events (
    id, recognition_session_id, schema_version, action, generated_title,
    writer_final_title, title_diff, field_graph, correction_type, operator_id,
    created_at, sem_standard_version
  ) values (
    feedback_id,
    p_session_id,
  ...
  insert into public.v4_learning_events (
    id, recognition_session_id, schema_version, event_type, generated_title,
    writer_final_title, field_level_ground_truth, candidate_reranker_dataset,
    hard_negative_samples, training_eligible, created_at, feedback_training_event,
    field_level_diff, candidate_changes, sem_standard_version, feedback_layer,
    semantic_learning_status, semantic_truth, writer_semantic_label_required
  ) values (
    learning_id,
    p_session_id,
