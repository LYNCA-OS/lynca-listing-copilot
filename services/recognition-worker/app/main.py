...
if FastAPI is not None:
    ...
    def readyz() -> dict[str, Any]:
        ...
        return {
            ...
            "paddleocr_role": config.paddleocr_role,
            "paddleocr_enable_hpi": config.paddleocr_enable_hpi,
            "paddleocr_detection_model_name": config.paddleocr_detection_model_name,
            "paddleocr_recognition_model_name": config.paddleocr_recognition_model_name,
            "paddleocr_cpu_threads": config.paddleocr_cpu_threads,
            "ocr_primary_backend": config.ocr_backend,
