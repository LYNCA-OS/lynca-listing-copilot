...
REGION_TEMPLATES = {
    ...
    "subject_name": (0.08, 0.05, 0.92, 0.30),
    "subject_slot_1": (0.08, 0.05, 0.92, 0.27),
    "subject_slot_2": (0.08, 0.32, 0.92, 0.54),
    "subject_slot_3": (0.08, 0.56, 0.92, 0.78),
    "parallel": (0.0, 0.0, 1.0, 1.0),
    "parallel_surface": (0.0, 0.16, 1.0, 0.74),
    "card_type": (0.0, 0.0, 1.0, 0.3),
    "autograph": (0.10, 0.54, 0.90, 0.78),
    "patch_relic": (0.16, 0.30, 0.84, 0.64),
